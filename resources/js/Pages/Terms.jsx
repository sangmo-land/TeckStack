                ...
                <div className="relative max-w-7xl mx-auto">
                    <div className="flex items-center space-x-4">
                        <div className="p-3 rounded-xl border border-flux/25 bg-flux/10">
                            <FileText className="w-8 h-8 text-flux" />
                        </div>
                        <div>
                            <h1 className="font-display text-4xl font-semibold tracking-tightest text-ink">Terms of Service</h1>
            ...
            <section className="px-4 sm:px-6 lg:px-8 py-12">
                <div className="max-w-4xl mx-auto">
                    <div className="panel rounded-2xl p-8 space-y-8">
                        {/* Agreement */}
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Agreement to Terms</h2>
                        ...
                        {/* Use License */}
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Use License</h2>
                            <p className="leading-relaxed text-ink-dim mb-4">
                        ...
                        {/* User Accounts */}
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">User Accounts and Registration</h2>
                            <p className="leading-relaxed text-ink-dim">
                        ...
                        {/* Course Content */}
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Course Content and Learning Materials</h2>
                            <p className="leading-relaxed text-ink-dim mb-4">
                        ...
                        {/* Payment Terms */}
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Payment and Refunds</h2>
                            <p className="leading-relaxed text-ink-dim mb-4">
                        ...
                        {/* User Conduct */}
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Prohibited Conduct</h2>
                            <p className="leading-relaxed text-ink-dim mb-4">
                                You agree not to:
                            </p>
                            <ul className="text-ink-dim space-y-2">
                        ...
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Instructor Responsibilities</h2>
                            <p className="leading-relaxed text-ink-dim">
                        ...
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Limitation of Liability</h2>
                            <p className="leading-relaxed text-ink-dim">
                        ...
                        {/* Termination */}
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Termination of Service</h2>
                            <p className="leading-relaxed text-ink-dim">
                        ...
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Intellectual Property Rights</h2>
                            <p className="leading-relaxed text-ink-dim">
                        ...
                        {/* Governing Law */}
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Governing Law</h2>
                            <p className="leading-relaxed text-ink-dim">
                        ...
                        {/* Changes to Terms */}
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Changes to Terms</h2>
                            <p className="leading-relaxed text-ink-dim">
                        ...
                        {/* Contact Information */}
                        <div>
                            <h2 className="font-display text-2xl font-semibold tracking-tighter text-ink mb-4">Contact Information</h2>
                            <p className="leading-relaxed text-ink-dim mb-4">
                                If you have any questions about these Terms of Service, please contact us:
                            </p>
                            <div className="p-4 rounded-xl border border-hairline bg-white/[0.03]">
