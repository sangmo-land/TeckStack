                ...
                <div className="relative max-w-7xl mx-auto">
                    <div className="text-center max-w-4xl mx-auto">
                        <div className="inline-flex items-center space-x-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-8">
                            ...
                            <span className="text-blue-400 text-sm font-medium">Empowering Tech Professionals Since 2025</span>
                        </div>
                        ...
                        <p className="text-xl text-slate-300 mb-12 leading-relaxed">
                            NelnadoSolutions is more than a learning platform—it's a community of passionate technologists, 
                            industry experts, and lifelong learners committed to excellence and innovation.
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-slate-300 mb-6 leading-relaxed">
                                At NelnadoSolutions, we're on a mission to democratize technology education and empower 
                                individuals to achieve their career goals through world-class learning experiences.
                            </p>
                            <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                                We believe that everyone deserves access to quality tech education, regardless of 
                                their background or location. That's why we've built a platform that combines 
                                expert instruction, hands-on projects, and career support.
                            </p>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {values.map((value, index) => (
                            ...
                            >
                                <div className={`absolute inset-0 bg-gradient-to-r ${value.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-300 rounded-2xl blur-xl`} />
                                <div className="relative bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 hover:border-slate-600 transition-all duration-300 h-full">
                                    <div className={`inline-flex p-3 bg-gradient-to-r ${value.gradient} rounded-lg mb-4`}>
                        ...
                        {team.map((member, index) => (
                            ...
                            >
                                <div className="relative mb-6 inline-block">
                                    <div className={`absolute inset-0 bg-gradient-to-r ${member.gradient} rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity`} />
                                    <div className={`relative w-40 h-40 bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden flex items-center justify-center mx-auto shadow-2xl ring-2 ring-white/5 group-hover:ring-blue-500/40 transition-all`}>   
                                        {member.avatar_url ? (
                                            <img
                                            ...
                                            <span className="text-3xl font-bold text-white">{(member.name || '?').split(' ').map(n => n[0]).join('').slice(0, 2)}</span>
                                        )}
                                    </div>
                                </div>
                                <h3 className="text-2xl font-bold text-white mb-2">{member.name}</h3>
                                <p className="text-blue-400 font-semibold mb-2 uppercase tracking-wide">{member.role}</p>
                                <p className="text-slate-300 text-sm">{member.expertise}</p>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="relative overflow-hidden bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl p-12 md:p-16">
                        ...
                        <div className="relative text-center max-w-3xl mx-auto">
                            ...
                            <p className="text-xl text-white/90 mb-8">
                                Join thousands of students who are already transforming their careers with NelnadoSolutions
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Link
                                    href="/courses"
