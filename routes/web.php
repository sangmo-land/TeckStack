...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/dashboard/courses/{course}/edit', [CourseController::class, 'edit'])->name('courses.edit')->whereNumber('course');
    Route::patch('/dashboard/courses/{course}', [CourseController::class, 'update'])->name('courses.update')->whereNumber('course');
});
